# resource "aws_iam_role" "terraform_codepipeline_role_employee" {
#   name = "terraform_codepipeline_role_employee"
...
#   role       = aws_iam_role.terraform_codepipeline_role_employee.id
# }
