...
ssm-infra-key-value-map = {
  ...
  "principal/ids"                                       = ["SecureString", "678323926802", "principal id"]
  ...
  "877760304415/iam/lambda-execution-role-arn" = ["String", "arn:aws:iam::877760304415:role/Lambda-nodejs-executionrole", "lambda role"]
}
